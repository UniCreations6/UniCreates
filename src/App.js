      ...
      photos: [
        {
          ...
          images: [
            ...
            { src: '/model1.jpeg', title: 'Model Look 1' },
            { src: '/model2.jpeg', title: 'Model Look 2' },
            { src: '/model3.jpeg', title: 'Model Look 3' },
            { src: '/model4.jpeg', title: 'Fashion Shot 1' },
            { src: '/model5.jpeg', title: 'Fashion Shot 2' },
            { src: '/model6.jpeg', title: 'Fashion Shot 3' },
            { src: '/model7.jpeg', title: 'Studio Portrait 1' },
            { src: '/model9.jpeg', title: 'Studio Portrait 2' },
            { src: '/model10.jpeg', title: 'Studio Portrait 3' },
            { src: '/model11.jpeg', title: 'Outdoor Look 1' },
            { src: '/model12.jpeg', title: 'Outdoor Look 2' },
            { src: '/model13.jpeg', title: 'Outdoor Look 3' },
            { src: '/model14.jpeg', title: 'Outdoor Look 4' },
            { src: '/model15.jpeg', title: 'Outdoor Look 5' },
            { src: '/model16.jpeg', title: 'Outdoor Look 6' },
          ]
        },
        {
          ...
          images: [
            { src: '/event1.jpeg', title: 'Event Photo 1' },
            { src: '/event2.jpeg', title: 'Event Photo 2' },
            { src: '/event3.jpeg', title: 'Event Photo 3' },
            { src: '/event4.jpeg', title: 'Event Photo 4' },
